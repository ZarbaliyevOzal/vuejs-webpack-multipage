<template>
    <div>
        <label class="font-bold">* I want to sell </label>
        <div class="mt-1 flex ">
            <a href="javascript:;" class="px-3 py-1 border border-blue-400 rounded" 
                :class="{'bg-blue-100': i_want_to_sell == 'car'}"
                @click="i_want_to_sell = 'car'">Car</a>
            <a href="javascript:;" class="px-3 py-1 ml-2 border border-blue-300 rounded" @click="i_want_to_sell = 'motorcycle'"
                :class="{'bg-blue-100': i_want_to_sell == 'motorcycle'}"
            >Motorcycle</a>
            <a href="javascript:;" class="px-3 py-1 ml-2 border border-blue-300 rounded" @click="i_want_to_sell = 'truck'"
                :class="{'bg-blue-100': i_want_to_sell == 'truck'}"
            >Truck</a>
        </div>
    </div>

    <div v-if="i_want_to_sell">
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="col-span-2 md:col-span-1">
                    <div class="">
                        ...
                        <div>
                            <Field name="make_id" as="select" class="form-control" @change="handleMakeChange(values.make_id)">
                                <option value="">Choose</option>
                                <option value="1" v-for="make in makes" :key="make.name">{{make.name}}</option>
                            </Field>
                            <div class="invalid-feedback block" v-if="errors.make_id">{{errors.make_id}}</div>
                        </div>
                    </div>
                </div>
                <div class="col-span-2 md:col-span-1">
                    <div class="">
                        ...
                        <div>
                            <Field name="model_id" as="select" class="form-control" disabled="!values.make_id">
                                <option value="">Choose</option>
                                <option value="1" v-for="model in models" :key="model.name">{{model.name}}</option>
                            </Field>
                            <div class="invalid-feedback block" v-if="errors.model_id">{{errors.model_id}}</div>
                        </div>
                    </div>
                </div>
                <div class="col-span-2 md:col-span-1">
                ...
                <div class="col-span-2 md:col-span-1">
                    <div class="">
                        <label class=" font-bold">* First Reg.</label>
                        <div>
                            <Field name="first_reg_year" as="select" class="form-control">
                                <option value="">choose</option>
                                <option v-for="n in years" :key="'year-' + n" :value="n">{{n}}</option>
                            </Field>
                            <div class="invalid-feedback block" v-if="errors.first_reg_year">{{errors.first_reg_year}}</div>
                        </div>
                    </div>
                </div>
                <div class="col-span-2 md:col-span-1">
                ...
                <div class="col-span-2 mt-8">
                    <label class="text-xl font-bold">Contact Information</label>
                    <div class="mt-1">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                <div> 
                                    ...
                                    <div>
                                        <!-- <input type="email" name="email" class="form-control" v-model="email" @change="handleChange"> -->
                                        <Field name="email" as="input" class="form-control"/>
                                        <div class="invalid-feedback block">{{errors.email}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-2 md:col-span-1">
